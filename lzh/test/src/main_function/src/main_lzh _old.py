        ...
        if fsm==Status.Explore:
            ...
            if params.people_exist==1:#exist people , exter Collect
                ...
                if waypoints_index==room_sum:
                    ...
                    pose_data.data="Finished recognizing people,enter Robbish Explore"
...
# unused
            ...
            rospy.sleep(2)
            params.people_sum+=1
            if params.people_sum==3 or waypoints_index==room_sum:
                rospy.loginfo("Finished recognizing people, enter Robbish Explore")
                pose_data.data="Finished recognizing people,enter Robbish Explore"
                Puber.over_speaking(pose_data)
                rospy.sleep(2)
        ...
        #robbish, similiar to face and pose recog
            ...
            success=Gotopoint(waypoints_name[9])
            rospy.loginfo(f"going {waypoints_name[9]}")
            #shi bie ???
