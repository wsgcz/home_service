...
bool operator==(const ::sound_play::SoundRequestGoal_<ContainerAllocator1> & lhs, const ::sound_play::SoundRequestGoal_<ContainerAllocator2> & rhs)
{
  return lhs.sound_request == rhs.sound_request;
}
