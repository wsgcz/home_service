...
all_room_center={"kitchen":[3.44,-2.57,9.39,0.609],"living":[1,1,1,1],"bedroom":[1,1,1,1],"dining_room":[1,1,1,1]}
            ...
            if self.label in list(msg_data.keys()):
                ...
                if d>0.0000001:
                    if self.target_count==0:
                        ...
                        reach_place1=[(map_x-0.5,map_y,0),(map_x,map_y+0.5,-math.pi/2),(map_x,map_y-0.5,math.pi/2),(map_x+0.5,map_y,math.pi)]
                        reach_place2=[(map_x-1.1,map_y,0),(map_x,map_y+1.1,-math.pi/2),(map_x,map_y-1.1,math.pi/2),(map_x+1.1,map_y,math.pi)]
                        dis=[]
                        self.judge_arrive_result=[]
                        (x1,y1,theta1)=(0,0,0)
                            ...
                            while(True):
                                ...
                                for i in range(4):
                                    ...
                                    if self.judge_arrive_result[i] <=253 and self.judge_arrive_result[i+4] <253:
                                        ...
                                        break                                      
                                break
                            if can_judge_or_not==0:
                                Gotopoint(all_room_center[self.grab_room_name])
