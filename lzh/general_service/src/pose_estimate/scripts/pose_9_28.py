...
def convert_machine_axis_to_world(results,width,height,x_mid,y_mid,depth,name):
    ...
    z_second = real_person[2] - 0.85* cos(alpha)
    x_second = real_person[0] + 0.85 * sin(alpha)
    ...
    real_people_x=real_person[2]
    real_people_y=real_person[0]
    tho_second2 = math.sqrt(real_people_x ** 2 + real_people_y ** 2)
    ...
    map_x=x_person
    map_y=y_person
    # reach_place2=[(map_x-0.7,map_y,math.pi),(map_x,map_y+0.7,-math.pi/2),(map_x,map_y-0.7,math.pi/2),(map_x+0.7,map_y,0)]
    reach_place2=[(map_x-0.85,map_y,0),(map_x,map_y+0.85,-math.pi/2),(map_x,map_y-0.85,math.pi/2),(map_x+0.85,map_y,math.pi),
                  ...
                  (map_x-1.1,map_y,0),(map_x,map_y+1.1,-math.pi/2),(map_x,map_y-1.1,math.pi/2),(map_x+1.1,map_y,math.pi)]
    distance_list=[]
