...
trt_engine = TRT_engine("/home/gcz/general_service/src/yolov7_tensorrt_ros/YOLOv7_Tensorrt/trt_model/yolov7_fp16.engine")
img = cv2.imread("/home/gcz/general_service/src/yolov7_tensorrt_ros/YOLOv7_Tensorrt/pictures/zidane.jpg")
