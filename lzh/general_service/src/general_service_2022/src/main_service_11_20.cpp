...
int main(int argc, char *argv[]) {
  ...
  if (gate_name.compare("B") == 0) {
    ROS_INFO("选择了B门");
    initial_pose_message.pose.pose.position.x = -2.68501;
    initial_pose_message.pose.pose.position.y = -2.09658;
    initial_pose_message.pose.pose.orientation.w = 1.0;
    initial_pose_message.pose.pose.orientation.z = 0.0;
  } else {
    ROS_INFO("选择了A门");
    initial_pose_message.pose.pose.position.x = 0.260987;
    initial_pose_message.pose.pose.position.y = -2.272372;
    initial_pose_message.pose.pose.orientation.w = 1.0;
    initial_pose_message.pose.pose.orientation.z = 0.0;
  }
