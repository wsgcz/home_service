...
const char * ASR_RES_PATH        = "/home/linxi/xf_off/src/asr_offline_record_sample/bin/msc/res/asr/common.jet"; //离线语法识别资源路径
const char * GRM_BUILD_PATH      = "/home/linxi/xf_off/src/asr_offline_record_sample/bin/msc/res/asr/GrmBuilld"; //构建离线语法识别网络生成数据保存路径
const char * GRM_FILE            = "/home/linxi/xf_off/src/asr_offline_record_sample/bin/msc/res/asr/call.bnf"; //构建离线识别语法网络所用的语法文件
