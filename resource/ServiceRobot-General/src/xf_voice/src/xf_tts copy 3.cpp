...
{
    int         ret                  = MSP_SUCCESS;
    const char* login_params         = "appid = 7947b326, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
...
//   ros::NodeHandle nh;
//   ros::Publisher pub=nh.advertise<std_msgs::String>("/start",10);
//   if (msg->data=="start")
//   {
//     if (ros::ok())
//     {
