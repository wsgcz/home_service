...
{
    int         ret                  = MSP_SUCCESS;
    const char* login_params         = "appid = 646baf12, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
...
class xf_speak
{
    ...
    {
        pub=n.advertise<std_msgs::String>("/start",10);
        sub =n.subscribe("xfsaywords",1000,&xf_speak::xfcallback,this);
        ros::spin();
    }
    void xfcallback(const std_msgs::String::ConstPtr& msg)
    {
