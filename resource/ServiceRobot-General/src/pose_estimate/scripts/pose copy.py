...
def convert_machine_axis_to_world(results,width,height,x_mid,y_mid,depth,name):
    global machine_odom_now_x,machine_odom_now_y,mathince_theta
    ...
    rospy.loginfo("this is x1  %f and this is y1 %f and name is %s",z_second,x_second,name)
...
def start_and_end_dopose2(msg:String):
    global start_work,choose_face_or_pose_flag
...
def get_odom_message(odom:Odometry):
    global machine_odom_now_y,machine_odom_now_x
