...
class machince_grab:
    ...
    def image_cb(self,image_rgb,image_depth):
        ...
        image = self._cv_bridge.imgmsg_to_cv2(image_rgb, desired_encoding='passthrough')
        depth = self._cv_bridge.imgmsg_to_cv2(image_depth, desired_encoding='passthrough')
            ...
            if self.label in list(msg_data.keys()):
                ...
                if d>0.0000001:
                    if self.target_count==0:
                        ...
                        reach_place2=[(map_x-0.9,map_y,0),(map_x,map_y+0.9,math.pi/2),(map_x,map_y-0.9,-math.pi/2),(map_x+0.9,map_y,math.pi)]
                        dis=[]
                        self.judge_arrive_result=[]
