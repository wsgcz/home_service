...
(cl:in-package sentence_voice-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Sentence>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sentence)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sentence_voice-msg:<Sentence> is deprecated: use sentence_voice-msg:Sentence instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Sentence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentence_voice-msg:header-val is deprecated.  Use sentence_voice-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'sentence-val :lambda-list '(m))
(cl:defmethod sentence-val ((m <Sentence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentence_voice-msg:sentence-val is deprecated.  Use sentence_voice-msg:sentence instead.")
  (sentence m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sentence>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%string sentence~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sentence)))
  "Returns full string definition for message of type 'Sentence"
  (cl:format cl:nil "std_msgs/Header header~%string sentence~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
