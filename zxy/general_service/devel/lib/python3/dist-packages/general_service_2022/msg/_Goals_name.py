...
"""autogenerated by genpy from general_service_2022/Goals_name.msg. Do not edit."""
import codecs
import sys
...
class Goals_name(genpy.Message):
  _md5sum = "5cba7b659cc9365a03ae2db68587ae95"
  _type = "general_service_2022/Goals_name"
...
"""
  __slots__ = ['name','goal']
  _slot_types = ['string','move_base_msgs/MoveBaseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Goals_name, self).__init__(*args, **kwds)
