...
echo_and_run cd "/home/zxy/general_service/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/zxy/general_service/build/image_pipeline/camera_calibration \
    build --build-base "/home/zxy/general_service/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
