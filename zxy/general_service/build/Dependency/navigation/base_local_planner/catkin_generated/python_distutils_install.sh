...
echo_and_run cd "/home/zxy/general_service/src/Dependency/navigation/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zxy/general_service/src/Dependency/navigation/base_local_planner/setup.py" \
     \
    build --build-base "/home/zxy/general_service/build/Dependency/navigation/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
