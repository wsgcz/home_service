...
#define PACKAGE_PATH         "/home/gcz/shopping/src/voice/bin/"
...
#define GRM_BUILD_PATH       concat(PACKAGE_PATH, "msc/res/asr/GrmBuilld")//"/home/riki/iflytek_awaken_asr-master/res/asr/GrmBuilld"; //构建离线语法识别网络生成数据保存路径
#define GRM_FILE             concat(PACKAGE_PATH, "call.bnf")//"/home/riki/iflytek_awaken_asr-master/res/asr/call.bnf"; //构建离线识别语法网络所用的语法文件
